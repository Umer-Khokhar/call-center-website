...
import { Trucks, Trip, OurStory, ChooseUs, Optimize, Footer } from '../components'
    ...
    <div className='home'>
        <div className="header">
            <div className="info main-txt pt-28">
                <h1 className='text-9xl w-10 -mt-16'>Your Trusted Dispatch Service</h1>
            </div>
            ...
            <div className="plans mb-6 flex justify-between items-center border-b-2 border-gray-200 border-opacity-60 pb-10">
                ...
                <img src={images.arrowRight} alt="Right Arrow"  width={40}/>
            </div>
        </div>
        <div className="trucks">
          <div className="content">
          <Trucks truck1={images.truck1} truck2={images.truck2} truck3={images.truck3}/>
          </div>
        </div>
